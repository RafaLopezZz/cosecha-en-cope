...
import com.rlp.cosechaencope.service.ClienteService;
 ...
 * <ul>
 * <li>GET /cosechaencope/usuario/cliente               → Listar todos los clientes</li>
 * <li>GET /cosechaencope/usuario/cliente/{idUsuario}   → Obtener datos de cliente por ID de usuario</li>
 * <li>PUT /cosechaencope/usuario/cliente/{idUsuario}   → Actualizar datos de cliente por ID de usuario</li>
 * </ul>
 *
 * <p>
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/cosechaencope/usuarios/clientes")
...
public class ClienteController {
    ...
    public ResponseEntity<ClienteResponse> obtenerClientePorUsuarioId(@PathVariable Long idUsuario) {
        ClienteResponse cliente = clienteService.obtenerClientePorUsuarioId(idUsuario);
     ...
     * @param clienteRequest DTO con los nuevos datos del cliente a
     * actualizar
    ...
    public ResponseEntity<ClienteResponse> actualizarCliente(
        ...
        ClienteResponse clienteActualizado = clienteService.actualizarCliente(idUsuario, clienteRequest);
