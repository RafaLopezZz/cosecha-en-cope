...
public class ClienteService {
     ...
     */
    public void crearCliente(Usuario usuario, ClienteRequest cDto) {
        if (cDto == null) {
            cDto = new ClienteRequest(); // Inicializar el DTO si es nulo
        }
     ...
     */
    public ClienteResponse obtenerClientePorUsuarioId(Long idUsuario) {
     ...
     * @throws ResourceNotFoundException si no existe un cliente con el ID dado.
     */
    public ClienteResponse actualizarCliente(Long idUsuario, ClienteRequest clienteDTO) {
        Cliente cliente = clienteRepository.findByUsuario_IdUsuario(idUsuario)
     ...
     */
    private ClienteResponse mapearResponseDTO(Cliente cliente) {
