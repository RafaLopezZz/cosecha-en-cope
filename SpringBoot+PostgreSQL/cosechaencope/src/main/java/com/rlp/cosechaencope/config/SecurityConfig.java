    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth
                        -> auth.requestMatchers("/", "/cosechaencope/auth/**").permitAll()
                        .requestMatchers(
                                "/v3/api-docs",
                                "/v3/api-docs/**",
                                "/swagger-ui.html",
                        ...
                        .requestMatchers("/cosechaencope/articulos").permitAll()
                        .requestMatchers("/cosechaencope/categorias").permitAll()
                        .requestMatchers("/cosechaencope/usuarios").permitAll()
                        .requestMatchers("/cosechaencope/usuario/{idUsuario}").permitAll()
                        .requestMatchers("/cosechaencope/usuarios/registro").permitAll()
                        .requestMatchers("/cosechaencope/usuarios/clientes").permitAll()
                        ...
                        .requestMatchers("/cosechaencope/pedidos").hasAnyRole("SUPERADMIN", "ADMIN", "USER", "CLIENTE")
